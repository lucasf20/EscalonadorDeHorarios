...
public class Disciplina {
    ...
    public static boolean laboratorio;
    ...
    Disciplina(int pos){
        ...
        laboratorio = BancoDeDados.getCollunm("laboratorio", "Disciplina")[pos].contains("t");
    ...
    Disciplina(String id_disp){
        ...
        laboratorio = BancoDeDados.getCollunm("laboratorio", "Disciplina",cond)[pos].contains("t");
